	...
	$.kinerSwiperPanel = function (options) {
		...
		var mySwiper = new Swiper(opts.conSelector + '.swiper-container', {
			...
			onSlideChangeStart: function (swiper) {
				...
				selectPanel(swiper.activeIndex, 1);
		...
		function selectPanel(index, type, e, ele) {
			console.log(index,type,e,ele);
			//请求接口
			if(index == 1 && type == 1 && e){
				communityTypeStatistical(6);
				communityTrendStatistical(6);
				communityPlatformStatistical(6);
			}else if(index == 2 && type == 1 && e){
				//人员类型统计
				humanTypeStatistical();
				//人员类型选择
				humanSelectType(3);
				//人员类型排行版
				humanTypeStatisticalRank(null);
				//人员相机排行版
				humanCaremaStatisticalRank(null)
			}else if(index == 3 && type == 1 && e){
				//车辆类型统计
				vehicleTypeStatistical();
				//车辆类型选择
				vehicleSelectType(4);
				//车辆类型排行版
				vehicleTypeStatisticalRank(null);
				//车辆相机排行版
				vehicleCaremaStatisticalRank(null)
			}
