<!--
 * @Author: yaoweixin
 * @Date: 2020-09-25 13:57:00
 * @LastEditors: yaoweixin
 * @LastEditTime: 2020-12-22 13:21:07
 * @Description: 中转站历史转运记录
 * @FilePath: \vue-cli-multiPage-master\src\pages\garbageClassification\TransitHistoryRecord.vue
-->
<template>
    <div class="transferHistoryRecord">
                ...
                <div class="statisticDetail" @scroll.self="scrollmy" ref="scrollContainer">
                    ...
                    <div class="line"></div>
                        <div class="removeBarrelTimesWrapper">
                            ...
                            <div class="removeBarrelTimesText"> 绿色垃圾</div>
                            <div class="text">（吨）</div>
                        </div>
                </div>
                <!-- 滚动滑块 -->
       ...
       <!-- <div class="statisticDetail">
           <div class="rubbishContainer">
               <div class="restRubbish">餐余垃圾：{{rubbish.restNumber}}公斤</div>
               <div class="recycleRubbish">可回收垃圾：{{rubbish.recycleNumber}}公斤</div>
           </div>
           <div class="rubbishContainer">
               <div class="harmRubbish">有害垃圾：{{rubbish.harmNumber}}公斤</div>
               <div class="other">其他垃圾：{{rubbish.otherNumber}}公斤</div>
           </div>
           <div class="bigRubbish">绿色垃圾：{{rubbish.bigNumber}}公斤</div>
           <div class="rubbishSum">垃圾总计：{{rubbish.sumNumber}}</div>
       </div> -->
       <!-- 中转记录内容 -->
        <van-collapse v-model="activeNames">
            <van-collapse-item v-for="(item,index) in transferList" :key="item.id" :name="index">
                <template #title>
                <div class="removeBarrelContainer">
                    <div class="transferTime">转运时间: {{item.withdrawTime}}</div>
                    <!-- <div class="transferClass">转运班次：2020年</div> -->
                </div>
                <div class="removeDetail">
                    <div class="removeBarrelMember">记录人员: {{item.garbageMemberEntity ? (item.garbageMemberEntity.name ? item.garbageMemberEntity.name : '') : ''}} 
                        <!-- <div>{{item.garbageMemberEntity.phone == null ? '' : '(' + item.garbageMemberEntity.phone + ')'}}</div> -->
                        <a :href="'tel:' + item.garbageMemberEntity.phone">
                    ...
                    <div class="restWrapper">
                        ...
                        <div class="restWent">
                            ...
                            <div class="wentContent">{{item.foodDriName}}</div>
                        </div>
                    </div>
                    <div class="restWrapper">
                        <div class="rest">
                        ...
                        <div class="restWent">
                            <div class="wentTitle">去向</div>
                            <div class="wentContent">{{item.otherDirName}}</div>
                        </div>
                    </div>
                     <div class="restWrapper">
                        <div class="rest">
                        ...
                        <div class="restWent">
                            <div class="wentTitle">去向</div>
                            <div class="wentContent">{{item.recyclableDirName}}</div>
                        </div>
                    </div>
                     <div class="restWrapper">
                        <div class="rest">
                        ...
                        <div class="restWent">
                            <div class="wentTitle">去向</div>
                            <div class="wentContent">{{item.harmfulDirName}}</div>
                        </div>
                    </div>
                     <div class="restWrapper">
                        <div class="rest">
                            <div class="restTitle">绿色垃圾</div>
                            <div class="restNumber">{{item.greenWaste}}吨</div>
                        </div>
                        <div class="restWent">
                            <div class="wentTitle">去向</div>
                            <div class="wentContent">{{item.greenDirName}}</div>
                        </div>
                    </div>
                <!-- <div class="other">其他：{{item.otherWaste}}公斤</div>
                <div class="rubbishContainer">
                    <div class="recycle">可回收：{{item.recyclableWaste}}公斤</div>
                    <div class="harm">有害：{{item.harmfulWaste}}公斤</div>
                </div>
                <div class="otherContainer">
                    <div class="bigRubbish">绿色垃圾：{{item.greenWaste}}公斤</div>
                </div> -->
                <div class="restRubbishAccurate">
                    <div class="restRubbishAccurateTitle">餐余垃圾精准率</div>
                    <div class="content">{{item.foodAccuracy}}%</div>
                </div>
                <div class="classifyAccurate">
                    <div class="classifyAccurateTitle">分类实效率</div>
                    <div class="content">{{item.classAccuracy}}%</div>
                </div>
      ...
      this.$refs.previewImage.previewShow = true;
        ...
        queryTransferByTime() {
            ...
            //console.log('endTIME',endTime)
             this.$http({
                url: this.$http.adornUrl(`/garbage/garbageTransferRegister/wxCount`),
                method: "post",
                ...
                if(data && data.code == 0) {
                    ...
                    this.rubbish.bigNumber = data.data.greenWasteCount
