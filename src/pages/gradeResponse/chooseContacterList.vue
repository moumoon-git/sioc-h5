  ...
  <div class="example">
    ...
    <div class="departmentcontainer">
      <template v-if="!peopleVisible">
        <div
          v-for="(item,index) in this.groupList"
          :key="index"
    ...
    <div class="bottomslide">
      <div class="choosepeople">已选择：{{contacterList.length}}人</div>
      <div class="yesbutton" @click="showChooseContacter">确定</div>
    </div>
    <chooseContacterDialog
      :show="dialogShow"
      :personNumber="personNum"
      @closeDialog="closeDialog"
      @transferOrder="transferOrd"
      :userArr="userList"
...
export default {
  ...
  methods: {
    ...
    addContacterList(item) {
      if (item.checked) {
        if (
          this.contacterList.filter((element) => {
  ...
  .example {
    .searchcontainer {
      ...
      .searchwrap {
        ...
        span.searchicon {
          ...
          // height: 2.55vh;
          height: 0.34rem;
          // margin: 0.6vh 1.1vw 0.6vh 2.13vw;
          margin: 0.08rem 1.1vw 0.08rem 2.13vw;
        }
    ...
    .departmentcontainer {
      ...
      .groupItem {
        ...
        background: white;
        // border: 1px solid;
        // border-bottom: 0.2vh solid #dddddd;
