<template>
  <div class="subordinateUnitDetail">
    ...
    <div class="detailMiddle">
      ...
      <div class="middleScreen" v-show="!indexIsSelect">
        <!-- <span
          class="screenText"
          @click="responseConditionQuery('rectificationReceiveBeginDate','rectificationReceiveEndDate','rectificationSearch','rectificationPlatformId')"
        >筛选</span>-->
        <span
          class="screenText"
    ...
    >
      ...
      <div class="bottomContent">
        ...
        <div>
          <span>响应负责人</span>
          <b style="marginLeft:-3.7vw">{{item.person}}</b>
          <b v-if="item.personPhone">({{item.personPhone}})</b>
    ...
    <div v-show="indexIsSelect && headerListData.status == '1'" style="marginBottom:19.19vh"></div>
    <div v-show="!indexIsSelect" style="marginBottom:1.5vh"></div>
    <div style="marginBottom:0.2rem"></div>
    <div class="detailFixed" v-show="indexIsSelect && headerListData.status == '1'">
      <div class="fixedSubmit">
        <button @click="submitResponse">提交响应</button>
      </div>
      <div class="fixedForward" @click="transmit">转发</div>
    </div>
    <!-- <imagePreview
...
export default {
  ...
  methods: {
    ...
    search() {
      this.$http({
        ...
        // this.headerListData = data.data.page.list[this.index];
      });
    },
    //响应记录带条件查询
    ...
    transmit() {
      // this.$http({
      //   url:this.$http.adornUrl(`/level/levelPublish/transmit`),
      //   method:"post",
      //   data:this.$http.adornData({
      //     manList:[100,200],
      //     id:3
    ...
    getScreenHeight() {
      ...
      // //console.log("获取到的屏幕的高度====》", getHeight);
  ...
  created() {
    ...
    //    //console.log('变化后的高度resizeHeight===》',resizeHeight,document.documentElement.clientHeight,document.body.clientHeight);
    //    if(resizeHeight < _this.initHeight){
    //   //    document.documentElement.clientHeight = _this.initHeight + 'px'
    //   //    document.body.clientHeight = _this.initHeight + 'px'
    //   // $('body').height(_this.initHeight);
    //   // $('body').css('height',_this.initHeight + 'px')
    //   document.body.style.height = _this.initHeight + 'px';
    //     //console.log(_this.initHeight + 'px',document.body.style.height);
    //     // window.innerHeight = _this.initHeight + 'px';
    //    }
    // };
    // this.$refs.responseSearch.focus(function(){
    //   document.body.style.height = _this.initHeight + 'px';
    // })
    ...
    // window.onload = () => {
    //   // 把获取到的高赋值给.flex
    //   document.getElementByclassName("subordinateUnitDetail").style.height = `${flexheight}px`;
    // };
